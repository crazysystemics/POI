...
class DiscreteTimeSimulationEngine
{
    ...
    public void Init()
    {
        ...
        Dictionary<int, Position> waypointDict = new Dictionary<int, Position>();
        waypointDict.Add(0, new Position(5, 5));
        waypointDict.Add(1, new Position(10, 10));
        waypointDict.Add(2, new Position(15, 10));
        waypointDict.Add(3, new Position(20, 5));
        waypointDict.Add(4, new Position(15, 0));
        waypointDict.Add(5, new Position(10, 5));


        Aircraft a = new Aircraft(waypointDict, 0);
