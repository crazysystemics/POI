class DiscreteTimeSimulationEngine
{
    ...
    public void Init()
    {
        ...
        Radar r = new(new Pulse(5, 15, 500, 5, 45, "E1"), new Position(0, 15), 30, "E1", Globals.Tick, 10, 1);
        Radar r2 = new(new Pulse(10, 10, 1000, 5, 45, "E2"), new Position(15, 10), 20, "E2", Globals.Tick, 10, 2);
