public class GCIRadar : Radar
{
    ...
    public GCIRadar(Position position, int radius, int beamWidth, int txTick, int endToEndDuration, int id, int startFrameAzimuth = 135, int endFrameAzimuth = 45)
    {
        ...
        this.radarType = Globals.RadarTypes.GCI;
