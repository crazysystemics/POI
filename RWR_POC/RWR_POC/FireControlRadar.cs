public class FireControlRadar : Radar
{
    ...
    public FireControlRadar(Pulse initPulse, Position position, int pulseRepetitionInterval, int txTick, int radius, int effectiveRadiatedPower, int id) : base(initPulse, position, pulseRepetitionInterval, txTick, radius, effectiveRadiatedPower, id)
    {
