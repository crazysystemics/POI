...
namespace OO_OSI
{
    ...
    public abstract class Packet<PayloadT>
    {
        ...
        public Header header;
        public Packet<PayloadT> payload; public Tail tail;
        Queue<Packet<PayloadT>> receive_from_upper_q;
        Queue<Packet<Packet<PayloadT>>> send_to_lower_q;
        //Commented === raw mode
        ...
        abstract public Packet<PayloadT>.Header GetHeader();
        abstract public Packet<PayloadT>.Tail GetTail();
        ...
        //Add Header and Tailer to Payload to form Packet
        ...
        abstract public Packet<PayloadT> GetPayloadFromLower();
        //Strip Header and Tailer to Paiload to form Packet
    ...
    {
        public new Layer< public new Layer<Layer<PayloadT>> lower; public Packet<PayloadT> packet;
        public Layer(Layer lower, Layer upper)
        {
            ...
            public Packet ReceiveFromLowerLayer(Packet p)
            {
                if (from_lower_layer_q.count > 0)
                    p = from_lower_layer_q.dequeue(); Packet up_packet; to_lower_layer.enqueue(up_packet.payload);
class Transport
...
//get source_ip: port
//get destination_ip:port //Determine next hop hw_send (packet); protected void receive( )
