...
to go
  ...
  let killaircraftprob  40
  let killassetprob  30
  ...
  ask planes [
    ...
    [
      ...
      [
        if killaircraftprob > random 100
        [
          ask plane [who] of myself [die]
        ]

        if killassetprob > random 100
        [
          ask asset [who] of self [die]
        ]
    ...
    [
      ...
      ask missiles [
        ...
        [
          ...
          if round y1 >= 16  [setxy min-pxcor min-pycor]
